...
def send_email(subject, body):
    ...
    password = os.getenv("enter env variable")  ## 12. It is not safe to store sensitive information in a script, best way to do it is to store it in an environment variable on your computer and then simply call it here by making sure the name is same. in this case, "EMAILSENDERPASS"
